...
| ship  | vorpal   | 1.0000 | PASS |
    ...
    **Mean H(label | image):** 1.5507 bits
    ...
    **Mean margin (d₂ − d₁):** 0.4097
    ...
    |---|---|---|---|
    | slithy   | 0.036403 | 0.192971 | 0.004116 |
| mimsy    | 0.023380 | 0.108748 | 0.002800 |
| vorpal   | 0.029685 | 0.188094 | 0.002843 |
  ...
  vorpal         0         0        20  
    ...
    With 15 seed images per category, the centroid-based lexicon
