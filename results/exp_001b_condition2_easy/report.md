    # Experiment 001b — Condition 2 (EASY)

    **Date:** 2026-05-25
    **Agent:** exp_001b — 10 seeds per category
    **Label assignment:** frog → slithy | horse → mimsy | ship → vorpal
    **Level:** EASY
    **Distractors:** airplane and deer — untrained CIFAR-10 categories with no visual overlap with frog/horse/ship
    ...
    **Total trials:** 60
    ...
    Overall accuracy: **0.9500** (threshold: > 0.7)
    ...
    |---|---|---|---|
    | frog  | slithy   | 0.9000 | PASS |
| horse | mimsy    | 1.0000 | PASS |
| ship  | vorpal   | 0.9500 | PASS |
    ...
    | Metric | Value |
    |---|---|
    | Mean retrieval margin (sim_correct − sim_best_distractor) | 0.2686 |
    | Mean entropy over candidates H(image\|label) | 1.5610 bits |
    ...
    **Entropy** measures how diffuse the similarity distribution is across
    ...
    |---|---|---|---|---|
    | slithy   | frog_c2_9            | deer_9               | deer     | -0.0381 |
| slithy   | frog_c2_16           | deer_16              | deer     | -0.0390 |
| vorpal   | ship_c2_14           | airplane_14          | airplane | -0.1209 |

    ---

    ## Interpretation

    The agent successfully retrieves correct images under distractor pressure at the easy difficulty level. Carroll labels are grounded in the centroid structure, not just memorised naming associations.
